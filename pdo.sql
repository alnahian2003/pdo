...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2095605485ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=categories">`laracrud`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=projects">`laracrud`.`projects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=users">`laracrud`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=personal_access_tokens">`laracrud`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=password_resets">`laracrud`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=migrations">`laracrud`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=failed_jobs">`laracrud`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laracrud&table=category">`laracrud`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bondhu&table=users">`bondhu`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bondhu&table=posts">`bondhu`.`posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="37522d264c7b2e6352733245283a3d3d">
